        ...
        <div className="bg-white shadow-xl rounded-2xl px-8 py-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="button"
              onClick={() =>
                alert(lang === "en" ? "Go to Sign Up" : "الذهاب إلى التسجيل")
              }
              className="w-full mt-3 bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium py-2 rounded-lg shadow-sm flex items-center justify-center gap-2 transition duration-200"
            >
